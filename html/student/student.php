...
$student_id = $_SESSION['student_id'];  // Adjusted for student

// SQL query to select student details by student_id
$sql = "SELECT * FROM student_registration WHERE student_id = ?";  // Adjusted for student table
                        ...
                        <form action="#" id="formAccountSettings" method="POST">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <p class="form-control" id="section"><?php echo isset($row['section']) ? htmlspecialchars($row['section']) : ''; ?></p>
                                </div>
                                <div class="mb-3 col-md-6">
