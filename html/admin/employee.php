...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $sqlCountQuery = "SELECT COUNT(*) AS total FROM employee_registration WHERE 1";
    ...
    $sqlquery = "SELECT * FROM employee_registration WHERE 1";
                                ...
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-lg-12">
                                            <div class="card-body">
                                                <div class="col-sm-12">
                                                    <h1 class="text-center mb-4 student-enrolle"><a href="dashboard.php">Available Employees</a></h1>
                                                    <!-- Search -->
                                                    ...
                                                    <!-- / Search -->
                                                    <button class="btn btn-primary mb-2"><a href="employee_registration.php">Add New Employee</a></button>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if (isset($result) && mysqli_num_rows($result) > 0) {
                                                                    while ($row = mysqli_fetch_array($result)) {
                                                                        ...
                                                                        echo "<td class='text-nowrap'>" . $row['position'] . "</td>";
                                                                        echo "<td class='action-icons text-nowrap'>";
                                                                        echo "<a href='view_employee_profile.php?employee_id=" . $row['employee_id'] . "'><i class='menu-icon tf-icons bx bx-show'></i></a>";
                                                                        echo "<a onclick=\"return confirm('Are you sure?')\" href='delete_employee.php?employee_id=" . $row['employee_id'] . "'><i class='menu-icon tf-icons bx bx-trash'></i></a>";
                                                                        echo "</td>";
                                                                        echo "</tr>";
                                                                        $counter++; 
                                                                    }
