                                ...
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-lg-12">
                                            <div class="card-body">
                                                <div class="col-sm-12">
                                                    <h1 class="text-center mb-4 student-enrolle"><a href="auth-register-basic.php">Available Employees</a></h1>
                                                    ...
                                                    <button class="btn btn-primary mt-2"><a href="employee_registration.php">Add New Employee</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
